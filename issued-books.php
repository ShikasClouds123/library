...
<?php 
$sid=$_SESSION['stdid'];
$sql="	SELECT tblissuedbookdetails.BookId,tblissuedbookdetails.IssuesDate,
		tblissuedbookdetails.ReturnDate,tblissuedbookdetails.id as rid,tblissuedbookdetails.Expirationdate ,tblissuedbookdetails.fine 
