...
$query->bindParam(':barcode',$bookId[0],PDO::PARAM_STR);
$query->execute();
...
<?php 
$sql = "SELECT tblstudents.FullName,tblissuedbookdetails.BookId,
		...
		from  tblissuedbookdetails join tblstudents 
		on tblstudents.StudentId=tblissuedbookdetails.StudentId where tblissuedbookdetails.id=:rid";
$query = $dbh -> prepare($sql);
$query->bindParam(':rid',$rid,PDO::PARAM_STR);
$query->execute();
...
<button type="submit" name="return" id="submit" class="button"><span>Return Book </span></button>
