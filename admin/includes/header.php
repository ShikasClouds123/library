                        ...
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
							...
							<li>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="add-Course.php">Add Course</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="add-YrLevel.php">Add Year Level</a></li> 
								</ul>
							 </li>
