...
if(isset($_POST["export"]))
{
 $query = "SELECT tblstudents.FullName,library_books.Book_Title,library_books.ISBN,tblissuedbookdetails.IssuesDate,
		tblissuedbookdetails.ReturnDate,tblissuedbookdetails.id as rid from  tblissuedbookdetails join tblstudents 
		on tblstudents.StudentId=tblissuedbookdetails.StudentId join library_books on 
