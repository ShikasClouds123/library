                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
						   ...
						   <?php 
							...
							$sql = "SELECT count(Bookid) AS total FROM librarybooks where Bookstatus = 'O' ";
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = 	"SELECT * FROM librarybooks where Bookstatus = 'O'";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
                                            ...
                                            <td class="center"><?php echo htmlentities($result->Copyright);?></td>
											 <td class="center"><?php echo htmlentities($result->Booktitle);?></td>
											  <td class="center"><?php echo htmlentities($result->Booksubtitle);?></td>
											   <td class="center"><?php echo htmlentities($result->Bookdescription);?></td>
											   <td class="center"><?php echo htmlentities($result->Bookauthor);?></td>
											    <td class="center"><?php echo htmlentities($result->Bookedition);?></td>
												 <td class="center"><?php echo htmlentities($result->Booklocation);?></td>
